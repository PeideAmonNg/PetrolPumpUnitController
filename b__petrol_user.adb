pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b__petrol_user.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__petrol_user.adb");
...
package body ada_main is
   ...
   E110 : Short_Integer; pragma Import (Ada, E110, "system__assertions_E");
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "petrol_pump_unit_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "petrol_pump_unit__finalize_spec");
      begin
         F1;
      end;
      E006 := E006 - 1;
   ...
   begin
      ...
      E006 := E006 + 1;
      Petrol_Pump_Unit'Elab_Spec;
      Petrol_Pump_Unit'Elab_Body;
      E107 := E107 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_petrol_user");
...
--  BEGIN Object file/option list
   --   C:\Users\pc\Desktop\swen421\petrolpump4\Petrol_Pump_Unit.o
   --   C:\Users\pc\Desktop\swen421\petrolpump4\Petrol_User.o
   --   -LC:\Users\pc\Desktop\swen421\petrolpump4\
   --   -LC:\Users\pc\Desktop\swen421\petrolpump4\
